...
function PlantsBarStats({ title, plantName }) {
...
function BarGraph() {
  return (
    <div className="row">
      <PlantsBarStats title="Lettuce" plantName="Lettuce" />
      <PlantsBarStats title="Mint" plantName="Mint" />
      <PlantsBarStats title="Coriander" plantName="Coriander" />
    </div>
  );
}
